...
class RedBlackTree : public TABLE<Key, Value> {
...
void RedBlackTree<Key, Value>::insert(Node*& node, const Key& key, const Value& value) {
    ...
    // Åñëè óçåë ïóñòîé, ñîçäàåì íîâûé óçåë
    ...
    // Èíà÷å âñòàâëÿåì óçåë êàê â îáû÷íîì áèíàðíîì äåðåâå ïîèñêà
    ...
    if (key < node->key) {
        ...
        // Åñëè êëþ÷ óæå ñóùåñòâóåò, ïðîñòî îáíîâëÿåì çíà÷åíèå
